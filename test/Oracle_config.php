<html>
    ...
    (CONNECT_DATA =
      ...
      (SERVICE_NAME = PROD1)
        ...
        } else {$dateFormatSet = oci_parse($conn, 'Alter Session SET NLS_DATE_FORMAT = "DD-MM-YYYY"');
        oci_execute($dateFormatSet);
        $stid = oci_parse($conn, 'SELECT * FROM vrsh_instructors where EMPLOYEE_ID=4320537');
