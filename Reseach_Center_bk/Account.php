        ...
        $(document).ready(function () {
            ...
            $('#form').jqxValidator({
                rules: [
                    ...
                    {input: '#passwordConfirm', message: 'من فضلك ادخل كلمة المرور', action: 'keyup, blur', rule: 'required', position: 'top'},
    ...
    <fieldset style="width: 95%;text-align: right;">
        ...
        <div class="panel_row">
            ...
            <div class="panel-cell"
                 style="padding-right: 75px;text-align: left;padding-left: 10px;vertical-align: middle;">
                <p class="classic">
                    تاريخ الانتهاء
                </p>
            </div>
