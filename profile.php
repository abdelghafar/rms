...
.art-content .art-postcontent-0 .layout-item-1 { color: #292929; background: #F2F2F2;  }
...
<nav class="art-nav">
    ...
    <ul class="art-hmenu"><li><a href="index.php" class="">الصفحة الرئيسية</a></li><li><a href="register.php" class="">تسجيل جديد</a></li><li><a href="login.php" class="">الدخول</a></li><li><a href="fqa.php" class="">الإستفسارات</a></li><li><a href="contactus.php" class="">بيانات الإتصال</a></li></ul> 
        </div>
    </nav>
...
<div class="art-layout-wrapper">
    ...
    <div class="art-layout-cell layout-item-0" style="width: 20%" >
        <p>menu<br/></p>
    </div><div class="art-layout-cell layout-item-1" style="width: 80%" >
        <p><br /></p>
    </div>
    </div>
</div>
...
<div class="art-content-layout">
    ...
    <div class="art-layout-cell layout-item-0" style="width: 100%">
        <p><span style="font-weight: bold;"><span style="text-shadow: rgb(0, 0, 0) 0px 0px 14px;">جميع الحقوق محفوظة&nbsp;</span><span style="text-shadow: rgb(0, 0, 0) 0px 0px 14px;">© معهد البحوث العلمية وإحياء التراث الإسلامى - جامعة أم القرى</span></span></p>
    </div>
    </div>
</div>
