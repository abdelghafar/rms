...
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            {
                window.showModalDialog("Change_Password.php?userId=" + userId, 'PopupPage', 'dialogHeight:300px; dialogWidth:500px; resizable:0');
                location.reload();
            }
        </script>
    </head>
                ...
                <tbody>
                    ...
                    while ($row = mysql_fetch_array($rs)) {
                        ...
                        <tr>
                            ...
                            <td style="text-align: center;"><a href="#" onClick="display_Change_Password(<? echo $row['user_id']; ?>);"><img src="images/edit.png" style="border:none !important" alt="تعديل"/></a></td>
                        </tr>
                        <?php
                    }
                    ?>
