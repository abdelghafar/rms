...
$smarty->assign('title', 'تقرير الميزانية المقترحة');
...
$rs = GetResearchBudgetAndCountByYearFn(1435);
?>
            ...
            <table id="datatables" class="display" style=" text-align: center;font-size:14px; font-weight: bold" dir="rtl" >
                <thead>
                    <tr>
                        <th><em>م</em></th>
                        <th>المركز البحثي</th>
                        <th>اجمالي الابحاث</th>
                        <th>نسبة عدد الابحاث</th>
                        <th>الميزانية المقترحة -SAR</th>
                        <th>نسبة الميزانية</th>
                    </tr>
                </thead>
                <tbody>
                    <?php
                    ...
                    foreach ($rs as $row) {
                        ...
                        <tr>
                            ...
                            <td style=" text-align: center;"><? echo $row['count']; ?></td>
                            <td style=" text-align: center;"><? echo '%' . number_format($row['rcount_percnt'], 2); ?></td>
                            <td style=" text-align: center;"><? echo number_format($row['budget'], 0); ?></td>
                            <td style=" text-align: center;"><? echo '%' . number_format($row['budget_percent'], 2); ?></td>
                        </tr>
                        <?php
                    }
                    ?>
                ...
                <tfoot>
                    <tr>
                        ...
                        <th style="text-align:center"><? echo $row['total_count']; ?></th>
                        <th style="text-align:center">100%</th>
                        <th style="text-align:center"><? echo number_format($row['total_budget'], 0); ?></th>
                        <th style="text-align:center">100%</th>
                    </tr>
                </tfoot>
            </table>
