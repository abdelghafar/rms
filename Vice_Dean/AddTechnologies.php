...
<html>
    ...
    <body style="background-color: #ededed;">
        <form id="AddEdit_Research_docs" enctype="multipart/form-data" method="POST" action="inc/AddTechnologies.inc.php?action=insert" target="form-iframe">
            <fieldset style="width: 600px;text-align: right;">
                ...
                <div class="panel_row">
                    ...
                    <div class="panel-cell" style="vertical-align: middle"> 
                        <input type="checkbox" name="chkIsVisible" value="ON" />
                    </div>
                </div> 
