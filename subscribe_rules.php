            ...
            <div class="panel_row" style="padding-right: 50px; height: 200px;">
                ...
                <div class="panel-cell">
                    <a href="forms/ISR-99-2013.doc">
                        <img src="common/images/invoice.png" alt="طلب تمويل" title ="طلب تمويل" style ="border:0;"/>
                ...
                <div class="panel-cell" style="padding-right:100px;">
                    <a href="forms/ISR-Proposal-Form.doc">
                        <img id="new_Research" src="common/images/document-open-8.png" alt="نموذج-2" title="نموذج-2" style ="border:0" /> 
                        <p style="margin-top: 0px;">
                            نموذج-2
                        </p>
                    </a>
                ...
                <div class="panel-cell" style="padding-right:100px;">
                    <a href="forms/ISR-Letter-3.doc">
                        <img id="new_Research" src="common/images/invoice.png" alt="نموذج-2" title="نموذج-2" style ="border:0" /> 
                        <p style="margin-top: 0px;">
                            طلب تمويل أجهزة
                        </p>
                    </a>
