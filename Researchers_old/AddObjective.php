...
<html>
    ...
    <body style="background-color: #ededed;">
        <form id="AddEdit_Research_docs" enctype="multipart/form-data" method="POST" action="inc/AddObjectivies.inc.php" target="form-iframe">
            ...
            <fieldset style="width: 600px;text-align: right;">
                ...
                <div class="panel_row">
                    ...
                    <div class="panel-cell" style="vertical-align: middle"> 
                        <textarea rows="4" cols="20" id="Desc" name="Desc">
                        </textarea>
                    </div>
                </div> 
