...
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            {
                window.showModalDialog("research_status_details_View.php?research_id=" + research_id + "&research_code=" + research_code, "name", "dialogWidth:620px;dialogHeight:300px");
                location.reload();
            }
            ...
            {
                window.showModalDialog("Assign_council_board.php?research_id=" + research_id + "&research_code=" + research_code, 'PopupPage', 'dialogHeight:490px; dialogWidth:760px; resizable:0');
                location.reload();
            }
            function display_Assign_Reviewer(research_id, research_code)
            {
                window.showModalDialog("Assign_Reviewer.php?research_id=" + research_id + "&research_code=" + research_code, 'PopupPage', 'dialogHeight:490px; dialogWidth:760px; resizable:0');
                location.reload();
            }
            function display_SendMessages(research_id, research_code)
            {
                window.showModalDialog("SendMessages.php?research_id=" + research_id + "&research_code=" + research_code, "name", "dialogWidth:600px;dialogHeight:330px");
            }
        </script>
    </head>
    <body>
                    ...
                    <tbody>
                        ...
                        while ($row = mysql_fetch_array($rs)) {
                            ...
                            <tr>
                                ...
                                <td style="text-align: center;"><a href="#" onClick="display_Assign_council_board(<? echo $row['seq_id'] . "," . $row['research_code'] ?>);"><img src="images/edit.png" style="border:none !important" alt="الفرز المبدئي"/></a></td>
                                <td><a href="#" onClick="display_Assign_Reviewer(<? echo $row['seq_id'] . "," . $row['research_code'] ?>);"><img src="images/edit.png" style="border:none !important" alt="تحكيم"/></a></td>
                                <td><a href="#" onClick="display_research_status(<? echo $row['seq_id'] . ",'" . $row['research_code'] . "'"; ?>);"><img src="../common/images/research-track.png" style="border:none !important" alt="تعديل"/></a></td>
                                <td>
                                    <a href="#" onClick="display_SendMessages(<? echo $row['seq_id'] . ",'" . $row['research_code'] . "'"; ?>);"><img src="images/sendmail.png" style="border:none !important" alt="حذف"/></a>
                                </td>
                                <td><a href="#" onClick="display_Research_details(<? echo $row['seq_id']; ?>);"><img src="../common/images/view-list-details.png" style="border:none !important" alt="حذف"/></a></td>
                            </tr>
                            <?php
                        }
                        ?>
