        ...
        <script type="text/javascript">
            ...
            $(document).ready(function() {
                    ...
                    var source =
                            {
                                ...
                                datafields: [
                                    ...
                                    {name: 'max_compensation_val', type: 'number'}
                                ],
                                ...
                                columns: [
                                    ...
                                    {text: 'Compensation/المكافأة ', datafield: 'compensation', width: 135, align: 'center', cellsalign: 'center', columntype: 'numberinput',
                                        validation: function(cell, value) {
                                            ...
                                            var role_comp = datarow.max_compensation_val;

                                            if (value < 0) {
                                                return {result: false, message: "قيمة غير صحيحة"};
                                            }
                                            if (value > role_comp) {
                                                return {result: false, message: "قيمة المكافأة الشهرية أكبر من الحد المسموح به لهذا العضو", position: 'right' };
                                            }
                                            return true;
                                        },
                                    ...
                                    {text: 'max_compensation_val', datafield: 'max_compensation_val', type: 'number', editable: false, width: 150, align: 'center', cellsalign: 'center', hidden: true}
                                ]
                            });
                }
                $("#outcomes_grd").on('cellendedit', function(event)
                {
                    ...
                    if (compensation <= role_comp)
                    {
                        if (column === 'compensation' && oldvalue !== compensation && compensation <= role_comp)
                        {
                    ...
                    {
                    //alert ("قيمة المكافأة الشهرية أكبر من الحد المسموح به لهذا العضو");
                    
//                    $("#outcomes_grd").jqxGrid('setcellvaluebyid', rowid, "compensation", oldvalue);
//                    alert(datarow.compensation);
                    }
        ...
        <fieldset style="width: 97%;text-align: right;"> 
            ...
            <div class="panel_row">
                ...
                <div class="panel-cell" style="width: 150px; vertical-align: middle"> 
                    <input type="hidden" id="total_buget" name="total_buget" style="font-size: 16;font-weight: bold;margin-right: 10; color: #0000cc ;text-align: center;" disabled="true" <?php
                    if ($project_budget_total == 0)
                        echo "value=0";
                    else
                        echo "value=" . $project_budget_total;
                    ?>>
                    <input type="text" id="manpower_buget" name="manpower_buget" style="font-size: 16;font-weight: bold;margin-right: 10; color: #0000cc ;text-align: center  !important;" disabled="true" <?php echo "value=" . $project_manpower_total; ?>>
                </div>
                ...
                <div class="panel-cell" style="vertical-align: middle"> 
                    <input type="text" id="manpower_percent" name="manpower_percent" style="font-size: 16;font-weight: bold;margin-right: 10; color: #0000cc ;text-align: center !important;" <?php echo "value=" . $manpower_percent; ?> />%
                </div>
            </div> 
        </fieldset>
