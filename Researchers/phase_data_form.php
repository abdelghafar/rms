...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#phasedataForm').jqxValidator({rules: [
            {input: '#phase_name', message: 'من فضلك ادخل عنوان المرحلة/ Please Enter Phase Title', action: 'keyup,blur', rule: 'minLength=3,required', rtl: true, position: 'topcenter'}
...
<form id="phasedataForm" enctype="multipart/form-data" method="POST">
    ...
    <input type="hidden" id="seq_id"
           name="seq_id" <?php if ($seq_id != 0) echo "value=" . $phase_rs["seq_id"]; else echo "value=0"; ?> >
    ...
    <fieldset style="width: 600px;text-align: right">
        ...
        <div class="panel_row">
            ...
            <div class="panel-cell" style="vertical-align: middle">
                <input type="text" id="phase_name"
                       name="phase_name" <?php if ($seq_id != 0) echo "value='" . $phase_rs["phase_name"] . "'"; ?>/>
            </div>
        </div>
        ...
        <div class="panel_row">
            ...
            <div class="panel-cell" style="vertical-align: middle">
                <textarea name="phase_desc" rows="4" cols="20"
                          id="phase_desc"><?php if ($seq_id != 0) echo $phase_rs["phase_desc"]; ?></textarea>
            </div>
        </div>
