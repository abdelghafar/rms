                ...
                var source =
                        {
                            ...
                            id: 'seq_id',
                            url: 'ajax/Researchers_View.php?id=<? echo $personId; ?>' + '&p=<? echo $_SESSION['program_id']; ?>' + '&q=1'
                        };
                            ...
                            columns: [
                                ...
                                {text: 'Submit / تسليم', datafield: 'submit', align: 'center', width: 90, columntype: 'button', cellsrenderer: function() {
                                        ...
                                        $.ajax({url: 'ajax/setSession.php?q=' + projectId, success: function(data) {
                                                $.ajax({url: 'ajax/IsSubmittingDuration.php?' , success: function(data) {
                                                        if (data == 0) {
                                                            alert("Submitting Duration doesn't start yet / لم يتم فتح وقت التقديم حتى الأن");
                                                        }
                                                        else {
                ...
                var SubmitDataSource =
                        {
                            ...
                            id: 'seq_id',
                            url: 'ajax/Researchers_View.php?id=<? echo $personId; ?>' + '&p=<? echo $_SESSION['program_id']; ?>' + '&q=0'
                        };
    ...
    <body style="background-color: #ededed;">
        ...
        <fieldset style="width: 97%;text-align: right;">
            <legend>
                <label>
                    <?
                    echo 'لوحة تحكم ' . $_SESSION['name_ar'] . "  لبرنامج  " . $_SESSION['program_alias'];
                    ?>
                </label>
            </legend>
            <div id='jqxWidget'
