...
<html>
                    ...
                    $("#outcomes_grd").jqxGrid(
                            {
                                ...
                                columns: [
                                    ...
                                    {text: 'Description/ الوصيف ', datafield: 'outcome_desc', type: 'string', width: 300, align: 'center', cellsalign: 'right'},
                                    ...
                                    {text: 'Assign a goal / تخصيص هدف', width: 180, datafield: '', align: 'center', columntype: 'button', cellsrenderer: function() {
    ...
    <body style="background-color: #ededed;">
        ...
        <fieldset style="width: 97%;text-align: right;"> 
            ...
            <input type="button" value="Add an outcome / إضافة مخرج" id='outcomeNewButton' style="margin-bottom: 15px;float: left "  />
        ...
        <table style="width: 100%;">
            <tr>
                <td>
                    <a href="resources_tasks.php" style="float: right;margin-top: 20px;">
