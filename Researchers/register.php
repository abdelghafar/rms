        ...
        <script type="text/javascript">
            $(document).ready(function () {
                $('#registerFrom').jqxValidator({rules: [
                        ...
                        {input: '#mobile', message: 'من فضلك ادخل رقم الجوال', action: 'keyup,blur', rule: 'required', rtl: true, position: 'topcenter'}, {input: "#password", message: "من فضلك ادخل كلمة المرور", action: 'keyup, blur', rule: 'required', position: 'left'},
