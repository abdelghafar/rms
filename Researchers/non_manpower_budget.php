...
تابع ميزانية المشروع(المتطلبات) / (Project Budget Cont.(Requirements
            ...
            <hr/>
            <input type="button" id='AddNewMaterials' value="Add new requirement / اضافة متطلب جديد" style="float: left;margin-bottom: 15px;"/>
            <br/>
            ...
            <hr/>
            <input type="button" id='AddNewTravel' value="Add new requirement / اضافة متطلب جديد" style="float: left;margin-bottom: 15px;"/>
            <br/>
            ...
            <hr/>
            <input type="button" id='AddNewOthers' value="Add new requirement / اضافة متطلب جديد" style="float: left;margin-bottom: 15px;"/>
            <br/>
