    ...
    <fieldset style="width: 95%;text-align: right;">
        ...
        <div class="panel_row">
            <div class="panel-cell" style="width: 200 ;text-align: left;padding-right: 700">
                <input type="button" value="Add Objective / إضافة هدف" id='ObjectiveNewButton'
            ...
            <tr>
                <td>
                    <a id="submit_button" href="#" onclick="next_step();"
                       style="float: right;margin-left: 25px;margin-top: 20px;">
                        <img src="images/next.png" style="border: none;" alt="next"/>
                    </a>
                </td>
                <td>
                    <a href="phases.php?q=<? echo $project_id; ?>"
