...
<html>
    ...
    <center>
        ...
        if ($isValid == TRUE) {
            ...
            $research_id = $researcher->Save(0, $title_ar, $title_en, $proposed_duration, $major_field, $special_field, $research_code, $Approve_session_no, $Approve_date, "uploads/Researchers/" . $fileName, $abstract_ar, $abstract_en, $Status_Id, $Status_Date, $research_center, $research_year, $budget);
            $x = $research_id;
        ...
        <label>
            <a href="../research_submit.php" style="float: left;margin-left: 25px;margin-top: 20px;">
                رجوع
            </a>
        </label>
    </center>
