        ...
        <form id="form" method="POST" enctype="multipart/form-data"> 
                ...
                <div class="panel_row">
                    ...
                    <div class="panel_row">
                        ...
                        <div class="panel-cell" style="vertical-align: middle"> 
                            <input class="textbox" type="text" placeholder="Nationality" name="Nationality" value="<? echo $Nationality; ?>"/>
                        </div>
                    </div>
                    ...
                    <div class="panel_row">
                        ...
                        <div class="panel-cell" style="vertical-align: middle"> 
                            <input class="textbox" type="text" placeholder="بلد الميلاد" name="CountryOfBirth" value="<? echo $CountryOfBirth ?>"/>
                        </div>
                    </div>
                </div>
            </fieldset>
            ...
            <fieldset style="width: 95%;text-align: right;"> 
                ...
                <div class="panel_row">
                    ...
                    <div class="panel-cell" style="vertical-align: middle"> 
                        <input name="college" class="textbox" type="text" placeholder="الكلية / الادارة" value="<? echo $College; ?>"/> 
                    </div>
                    <div class="panel-cell" style="width:170px;text-align: left;padding-left: 10px;vertical-align: middle;">
                        <p style="font-weight: bold">
                            القسم
            ...
            <fieldset style="width: 95%;text-align: right;"> 
                ...
                <div class="panel_row">
                    ...
                    <div class="panel-cell" style="vertical-align: middle"> 
                        <input id="postal_code" class="textbox" type="text" placeholder="الرمز البريدي" name="postal_code" value="<? echo $Postal_Code; ?>"/>
                    </div>
                </div>
            </fieldset>
            <br/> 
