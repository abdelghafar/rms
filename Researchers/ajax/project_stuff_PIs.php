...
if (isset($_GET['q'])) {
    ...
    $stmt = "SELECT DISTINCT persons.Person_id,persons.Position,persons.Major_Field, name_ar,stuff_roles.role_name,persons.empCode from persons join research_stuff on research_stuff.person_id = persons.Person_id  join stuff_roles on stuff_roles.seq_id = research_stuff.role_id where research_stuff.research_id=" . $projectId . " and research_stuff.role_id =1";
