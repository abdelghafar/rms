...
if (isset($_GET['q'])) {
    ...
    $stmt = 'select project_budget.seq_id, project_budget.amount, project_budget.`desc`, budget_items.item_title  , budget_items.item_title_en from project_budget join budget_items on project_budget.item_id= budget_items.item_id where budget_items.parent_item_id=' . $t->materials_code() . ' and project_budget.project_id=' . $project_id;
