...
<form method="POST" target="form-iframe" id="ResearchEditForm" enctype="multipart/form-data"
      action="inc/ResearchEdit.inc.php" style=" font-size: 17px;font-weight: bold;color:#2191c0;">
    ...
    <fieldset style="width: 95%;text-align: right;">
        ...
        <div class="panel_row">
            ...
            <div class="panel-cell">
                <input id="title_ar" class="textbox" type="text" placeholder="عنوان البحث باللغة العربية"
                       name="title_ar" value="<? echo $rs['title_ar']; ?>"/>
            </div>
        </div>
        <div class="panel_row">
            <div class="panel-cell" style="width: 200px;text-align: left;padding-left: 10px;">
            ...
            <div class="panel-cell">
                <input id="title_en" class="textbox" type="text" placeholder="عنوان البحث - اللغة الانجليزية"
                       value="<? echo $rs['title_en']; ?>" name="title_en"/>
            </div>
        </div>
        <div class="panel_row">
        ...
        <div class="panel_row">
            ...
            <div class="panel-cell">
                <input id="major_field" class="textbox" type="text" placeholder="التخصص العام"
                       value="<? echo $rs['major_field']; ?>" name="major_field"/>
            </div>
            ...
            <div class="panel-cell">
                <input id="special_field" class="small_textbox" type="text" placeholder="التخصص الدقيق"
                       value="<? echo $rs['special_field']; ?>" name="special_field"/>
            </div>
        </div>
        <div class="panel_row">
